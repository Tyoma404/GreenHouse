...
//НАЧАЛО НАСТРОЕК АВТОРИЗАЦИИ
var signin_btn_choise = document.querySelector('signIn_btn');
var signup_btn_choise = document.querySelector('signUp_btn');
var signin_btn = document.querySelector('signIn_btn');
var signup_btn = document.querySelector('sign_btn');
var logOut_btn = document.querySelector('logOut_btn');
var doc = document.querySelector('link[rel="import"]').import;
var signIn = doc.querySelector('#signin');
...
document.body.appendChild(signIn.cloneNode(true));
document.body.appendChild(signUp.cloneNode(true));
document.body.appendChild(logOUT.cloneNode(true));
document.body.appendChild(logOUT.cloneNode(true));

//КОНЕЦ НАСТРОЕК АВТОРИЗАЦИИ